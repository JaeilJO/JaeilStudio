...
const S = {
    IconBoxWhite: styled(CommonIconBoxStyle)`
        color: ${({ $disabled, theme }) => ($disabled ? theme.color.gray_600 : theme.color.primary_700)};
        &:hover {
    ...
    IconBoxBlack: styled(CommonIconBoxStyle)`
        color: ${({ $disabled, theme }) => ($disabled ? theme.color.gray_600 : theme.color.white)};
        &:hover {
